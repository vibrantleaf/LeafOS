...
install -Dm 644 /sources/org.codeberg.vibrantleaf.waydroid-wizard/LICENSE.en_UK.txt /usr/share/org.codeberg.vibrantleaf.waydroid-wizard/LICENSE.en_UK.txt
