...
COPY cosign.pub /keys/sharkfin-nvidia.pub


# Main image
FROM ghcr.io/ublue-os/bluefin-nvidia@sha256:fb903a867285dc6f167534a8988d6adf8725bbf1261d5a3b610170b585c4b617 AS sharkfin-nvidia
ARG RECIPE=recipes/sharkfin-nvidia.recipe.yaml
ARG IMAGE_REGISTRY=localhost
ARG CONFIG_DIRECTORY="/tmp/files"
ARG MODULE_DIRECTORY="/tmp/modules"
ARG IMAGE_NAME="sharkfin-nvidia"
ARG BASE_IMAGE="ghcr.io/ublue-os/bluefin-nvidia"
ARG FORCE_COLOR=1
...
--mount=type=bind,from=ghcr.io/blue-build/cli/build-scripts:7828e7872b342d05302417db1bd94bf93d347383,src=/scripts/,dst=/tmp/scripts/ \
  --mount=type=cache,dst=/var/cache/rpm-ostree,id=rpm-ostree-cache-sharkfin-nvidia-stable,sharing=locked \
  --mount=type=cache,dst=/var/cache/libdnf5,id=dnf-cache-sharkfin-nvidia-stable,sharing=locked \
...
LABEL org.blue-build.build-id="6394c563-9de9-4ba8-b789-6e38cf88b290"
LABEL org.opencontainers.image.title="sharkfin-nvidia"
LABEL org.opencontainers.image.description="This is just my persoanl fork of bluefin."
LABEL org.opencontainers.image.source=""
LABEL org.opencontainers.image.base.digest="sha256:fb903a867285dc6f167534a8988d6adf8725bbf1261d5a3b610170b585c4b617"
LABEL org.opencontainers.image.base.name="ghcr.io/ublue-os/bluefin-nvidia:stable"
LABEL org.opencontainers.image.created="2025-06-18T23:14:32.285576243+00:00"
