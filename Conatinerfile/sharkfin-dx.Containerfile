...
COPY cosign.pub /keys/sharkfin-dx.pub


# Main image
FROM ghcr.io/ublue-os/bluefin-dx@sha256:01ec596d2477b2b1c4bd0af2db3a3de561f5dc9452ad98656c1efbd6a00d3ce1 AS sharkfin-dx
ARG RECIPE=recipes/sharkfin-dx.recipe.yaml
ARG IMAGE_REGISTRY=localhost
ARG CONFIG_DIRECTORY="/tmp/files"
ARG MODULE_DIRECTORY="/tmp/modules"
ARG IMAGE_NAME="sharkfin-dx"
...
--mount=type=bind,from=ghcr.io/blue-build/cli/build-scripts:7828e7872b342d05302417db1bd94bf93d347383,src=/scripts/,dst=/tmp/scripts/ \
  --mount=type=cache,dst=/var/cache/rpm-ostree,id=rpm-ostree-cache-sharkfin-dx-stable,sharing=locked \
  --mount=type=cache,dst=/var/cache/libdnf5,id=dnf-cache-sharkfin-dx-stable,sharing=locked \
...
LABEL org.blue-build.build-id="b82e2e23-8b77-4d42-931e-686ddb1a63d0"
LABEL org.opencontainers.image.title="sharkfin-dx"
LABEL org.opencontainers.image.description="This is just my persoanl fork of bluefin."
LABEL org.opencontainers.image.source=""
LABEL org.opencontainers.image.base.digest="sha256:01ec596d2477b2b1c4bd0af2db3a3de561f5dc9452ad98656c1efbd6a00d3ce1"
LABEL org.opencontainers.image.base.name="ghcr.io/ublue-os/bluefin-dx:stable"
LABEL org.opencontainers.image.created="2025-06-18T23:14:08.518508004+00:00"
