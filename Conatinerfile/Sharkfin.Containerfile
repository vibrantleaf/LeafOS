...
COPY cosign.pub /keys/sharkfin.pub


# Main image
FROM ghcr.io/ublue-os/bluefin@sha256:e17c57ae416e3a5d23dc0681be2997ef2dfe7c99f6d06104085f69182b94b58a AS sharkfin
ARG RECIPE=recipes/sharkfin.recipe.yaml
...
--mount=type=bind,from=ghcr.io/blue-build/cli/build-scripts:7828e7872b342d05302417db1bd94bf93d347383,src=/scripts/,dst=/tmp/scripts/ \
  --mount=type=cache,dst=/var/cache/rpm-ostree,id=rpm-ostree-cache-sharkfin-stable,sharing=locked \
  --mount=type=cache,dst=/var/cache/libdnf5,id=dnf-cache-sharkfin-stable,sharing=locked \
...
LABEL org.blue-build.build-id="8c9b82ca-6017-40cf-bf5a-dae3d0d37e6d"
...
LABEL org.opencontainers.image.created="2025-06-19T04:23:05.298123450+00:00"
